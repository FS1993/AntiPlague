...
public class Latwy extends JFrame{
	...
	public Latwy() {
		...
		KrajFrameLatwy polska = new KrajFrameLatwy("Polska", polskaButton, kraje, this, zarazeniTextField, punktyTextField);
		polska.setVisible(false);
		polska.setDefaultCloseOperation(HIDE_ON_CLOSE);
		polska.setLocation(50, 50);
		
		KrajFrameLatwy chiny = new KrajFrameLatwy("Chiny", chinyButton, kraje, this, zarazeniTextField, punktyTextField);
		chiny.setVisible(false);
		chiny.setDefaultCloseOperation(HIDE_ON_CLOSE);
		chiny.setLocation(240, 50);
		
		KrajFrameLatwy rosja = new KrajFrameLatwy("Rosja", rosjaButton, kraje, this, zarazeniTextField, punktyTextField);
		rosja.setVisible(false);
		rosja.setDefaultCloseOperation(HIDE_ON_CLOSE);
		rosja.setLocation(430, 50);
		
		KrajFrameLatwy usa = new KrajFrameLatwy("USA", usaButton, kraje, this, zarazeniTextField, punktyTextField);
		usa.setVisible(false);
		usa.setDefaultCloseOperation(HIDE_ON_CLOSE);
		usa.setLocation(860, 50);
		
		KrajFrameLatwy brazylia = new KrajFrameLatwy("Brazylia", brazyliaButton, kraje, this, zarazeniTextField, punktyTextField);
		brazylia.setVisible(false);
		brazylia.setDefaultCloseOperation(HIDE_ON_CLOSE);
		brazylia.setLocation(1060, 50);
		
		KrajFrameLatwy indie = new KrajFrameLatwy("Indie", indieButton, kraje, this, zarazeniTextField, punktyTextField);
		indie.setVisible(false);
		indie.setDefaultCloseOperation(HIDE_ON_CLOSE);
		indie.setLocation(1260, 50);
		
		KrajFrameLatwy japonia = new KrajFrameLatwy("Japonia", japoniaButton, kraje, this, zarazeniTextField, punktyTextField);
		japonia.setVisible(false);
		japonia.setDefaultCloseOperation(HIDE_ON_CLOSE);
		japonia.setLocation(50, 400);
		
		KrajFrameLatwy rpa = new KrajFrameLatwy("RPA", rpaButton, kraje, this, zarazeniTextField, punktyTextField);
		rpa.setVisible(false);
		rpa.setDefaultCloseOperation(HIDE_ON_CLOSE);
		rpa.setLocation(240, 400);
		
		KrajFrameLatwy niemcy = new KrajFrameLatwy("Niemcy", niemcyButton, kraje, this, zarazeniTextField, punktyTextField);
		niemcy.setVisible(false);
		niemcy.setDefaultCloseOperation(HIDE_ON_CLOSE);
		niemcy.setLocation(430, 400);
		
		KrajFrameLatwy uk = new KrajFrameLatwy("Wielka Brytania", ukButton, kraje, this, zarazeniTextField, punktyTextField);
		uk.setVisible(false);
...
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Polska", polskaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Chiny", chinyButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Rosja", rosjaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("USA", usaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Brazylia", brazyliaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Indie", indieButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Japonia", japoniaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("RPA", rpaButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Niemcy", niemcyButton, kraje, this, zarazeniTextField));
//		SwingUtilities.invokeLater(()-> new KrajFrameLatwy("Wielka Brytania", ukButton, kraje, this, zarazeniTextField));
		...
		Thread glowny = new Thread(()->{
			while(true) {
				...
				if((zarazeniSwiata >= populacjaSwiata) || 
						...
						||
						(zarazeniSwiata <= 0) ) {
					long wynik = (populacjaSwiata - zarazeniSwiata)/(czas);
