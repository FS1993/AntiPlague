...
public class Trudny extends JFrame{

	List<KrajButton> kraje;
	int wskaznik = 0;
	long populacjaSwiata = 0,
		zarazeniSwiata = 100000,
		zdrowiSwiata = 0,
		punkty = 9000;
	long czas = 0;
	...
	public Trudny() {
		...
		KrajFrameTrudny polska = new KrajFrameTrudny("Polska", polskaButton, kraje, this, zarazeniTextField, punktyTextField);
		polska.setVisible(false);
		polska.setDefaultCloseOperation(HIDE_ON_CLOSE);
		polska.setLocation(50, 50);
		
		KrajFrameTrudny chiny = new KrajFrameTrudny("Chiny", chinyButton, kraje, this, zarazeniTextField, punktyTextField);
		chiny.setVisible(false);
		chiny.setDefaultCloseOperation(HIDE_ON_CLOSE);
		chiny.setLocation(240, 50);
		
		KrajFrameTrudny rosja = new KrajFrameTrudny("Rosja", rosjaButton, kraje, this, zarazeniTextField, punktyTextField);
		rosja.setVisible(false);
		rosja.setDefaultCloseOperation(HIDE_ON_CLOSE);
		rosja.setLocation(430, 50);
		
		KrajFrameTrudny usa = new KrajFrameTrudny("USA", usaButton, kraje, this, zarazeniTextField, punktyTextField);
		usa.setVisible(false);
		usa.setDefaultCloseOperation(HIDE_ON_CLOSE);
		usa.setLocation(860, 50);
		
		KrajFrameTrudny brazylia = new KrajFrameTrudny("Brazylia", brazyliaButton, kraje, this, zarazeniTextField, punktyTextField);
		brazylia.setVisible(false);
		brazylia.setDefaultCloseOperation(HIDE_ON_CLOSE);
		brazylia.setLocation(1060, 50);
		
		KrajFrameTrudny indie = new KrajFrameTrudny("Indie", indieButton, kraje, this, zarazeniTextField, punktyTextField);
		indie.setVisible(false);
		indie.setDefaultCloseOperation(HIDE_ON_CLOSE);
		indie.setLocation(1260, 50);
		
		KrajFrameTrudny japonia = new KrajFrameTrudny("Japonia", japoniaButton, kraje, this, zarazeniTextField, punktyTextField);
		japonia.setVisible(false);
		japonia.setDefaultCloseOperation(HIDE_ON_CLOSE);
		japonia.setLocation(50, 400);
		
		KrajFrameTrudny rpa = new KrajFrameTrudny("RPA", rpaButton, kraje, this, zarazeniTextField, punktyTextField);
		rpa.setVisible(false);
		rpa.setDefaultCloseOperation(HIDE_ON_CLOSE);
		rpa.setLocation(240, 400);
		
		KrajFrameTrudny niemcy = new KrajFrameTrudny("Niemcy", niemcyButton, kraje, this, zarazeniTextField, punktyTextField);
		niemcy.setVisible(false);
		niemcy.setDefaultCloseOperation(HIDE_ON_CLOSE);
		niemcy.setLocation(430, 400);
		
		KrajFrameTrudny uk = new KrajFrameTrudny("Wielka Brytania", ukButton, kraje, this, zarazeniTextField, punktyTextField);
		uk.setVisible(false);
		...
		Thread glowny = new Thread(()->{
			...
			while(true) {
				...
				if((zarazeniSwiata >= populacjaSwiata) || 
						...
						||
						(zarazeniSwiata <= 0) ) {
					long wynik = 3*(populacjaSwiata - zarazeniSwiata)/(czas);
